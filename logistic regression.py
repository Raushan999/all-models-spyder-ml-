...
dataset = pd.read_csv("C:/Users/HP/Downloads/alldata/Social_Network_Ads.csv")
...
#Feature Scaling (Because we need to make more accurate prediction, as the salary is
#far more exceeding than the age)
...
mp.title('Logistic Regression(Training Set)')
mp.xlabel('Age')
